...
<body>
    <div class="banner">
        ...
        <div class="content">
            ...
            <p>This website is still on ongoing update.</p>
            <div id= scroll_container>
                <div id="scroll_text">
                    <h6>For more information, please send an email to <a href="#"></a><strong><i class="text-warning">nre.training.services@hotmail.com</a></i></strong></h6>
                </div>
            </div>
    </div> 
