...
var topics = ['p_topic2.1.php', 'gre_vpn_unprotected_2.png', 'p_lab.php','p_topic2.2.php','p_topic2.3.php','p_topic2.4.php','p_topic2.5.php','p_topic2.6.php','p_topic2.7.php','p_topic2.8.php','p_topic2.9.php','p_topic3.0.php']; // Different Topics to be displayed onto the inframe container
var dir = '/html_css_java/TaaS/perimeter/b2b_up/';
