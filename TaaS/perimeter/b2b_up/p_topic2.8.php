...
<body>
    ...
    Unfortunately, the B2B user and the Servers are still doesn't have reachability, to solve this we will be configuring a <i><b>OSPF routing protocol</b></i>. 
    You can use other routing protocols such as <i><b class="text-warning">Static Routing</b></i>, <i><b class="text-warning">RIPv2</b></i>, <i><b class="text-warning">EIGRP</b></i>, and <i><b class="text-warning">BGP</b></i>.
    <br><br>
    
    <b class="text-warning">Lab Tasks:</b> <i>Cont...</i> <br>
    Step 1: Click the R2 in the Lab instance under ALL CONNECTIONS. <br>
    ...
    Step 4: Type <i><b>ip route 10.10.10.0 255.255.255.0 172.19.10.1</b></i>, Type <i><b>end</b></i> then press enter. <br>
