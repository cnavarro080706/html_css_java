...
<body>
    <div class="banner">
        <div class="navbar">
            ...
            <ul>
                <li><a href="/html_css_java/TaaS/settings/settings.php">settings</a></li>
            ...
            <div class="container-fluid overflow-hidden text-white mx-auto">
                <div class="row align-items-start">
                    <div class="col-6">
                        <div class="container">
                            <iframe id="d_topic2.1" class="slider_topic ms-5" width="100%" height="470" src="d_topic2.1.php" frameborder="0" scrolling="no"></iframe>
                        </div>
                    ...
                    <div id="imageContainer" class="col-6 d-flex justify-content-center align-items-center">
                        <img id="layer2" src="../dc_img/DC_ipfabric.png" alt="Data Center Image" class="img-fluid">
                    </div>
                    <div class="col-6">
                        <div id="iframeContainer" class="ratio">
                            <iframe id="netlab" class="embed-responsive-item"  width="100%" height="100%" data-src="http://192.168.0.10:8988/#/?username=testuser01&password=admin" allowfullscreen></iframe>
                        </div>
                    </div>
            </div>
