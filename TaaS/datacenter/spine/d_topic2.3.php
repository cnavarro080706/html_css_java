...
<body>
   ...
   <b class="text-warning">LAB Tasks Cont...</b>: Configuring Spine Switches L3 Links<br><br>
   Step 1: Type <i><b>interface Ethernet4</b></i>. then press enter. This is the interface facing DCC02<br>
   Step 2: Type <i><b>no switchport</b></i>. then press enter.<br>
   Step 3: Type <i><b>ip add 172.16.2.2/24</b></i>.then press enter. <br>
   Step 4: Type <i>no shutdown<i>, then type <b class="text-warning">exit</b> then press enter.<br>
   Step 5: Type <i><b>write memory</b></i>, then <i><b>copy run start</b></i> then <i><b>enter</b></i> to save your configurations.
