...
<body>
   ...
   <b class="text-info">Important Note</b>: For this lab tasks - we will focus only on two SPINE Switches configurations (Spine01 and 02) the other Spines will be preconfigured for the learner to understand the basics of IP Fabric Spine Layer connectivity. We will be using Arista Layer 3 switches for this Lab instance. <br><br>
   ...
   Step 5: Type <i><b>interface Ethernet3</b></i>. then press enter. This is the interface facing DCC01<br>
   Step 6: Type <i><b>no switchport</b></i>. then press enter.<br>
   Step 7: Type <i><b>ip add 172.16.1.2/24</b></i>.then press enter.<br>
