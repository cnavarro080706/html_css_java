                ...
                <div class="row align-items-start">
                    <div class="col-6">
                        ...
                        <div id="congrats" class="visually-hidden text-light">
                            <h4 class="mt-1 text-warning">Congratulations!</h4>You can now continue with your tasks!
                            <p>You can close the Lab instance by:
                            Exit on the Switch Environment, then Click Logout, or Click the layer3_user, click Logout.
                    ...
                    <div id="imageContainer" class="col-6 d-flex justify-content-center align-items-center">
                        <img id="layer2" src="../campus_img/layer3_switching.png" alt="Data Center Image" class="img-fluid">
                    </div>
                    <div class="col-6">
                        <div id="iframeContainer" class="ratio">
                            <iframe id="netlab" class="embed-responsive-item"  width="100%" height="100%" data-src="http://192.168.0.10:8988/#/?username=layer3_user&password=admin" allowfullscreen></iframe>
                        </div>
                    </div>
            </div>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <script src="../js_l3/main.js"></script>
    <script src="../js_l3/button.js"></script>
