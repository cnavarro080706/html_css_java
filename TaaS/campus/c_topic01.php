    ...
    <div class="banner">
        <div class="navbar">
            ...
            <ul>
                ...
                <li> <a href="campus.php" onclick="if (confirm('Are you sure you want to go back to Campus page?')) { window.location = 'campus.php'}">Back</a></li>
            </ul>
        </div>
        <hr>
        <div class="container-fluid overflow-hidden text-white">
            ...
            <div class="col-6">
                <div id="iframeContainer" class="ratio">
                    <iframe id="netlab" class="embed-responsive-item" data-src="http://192.168.0.10:8988/#/?username=campus_user&password=admin" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <script src="js_l2/taas.js"></script>
    <hr>
