...
<body>
    <div class="banner">
        <div class="navbar">
            <img src="/html_css_java/img/nre_logo.png" class="logo">
            <ul>
            ...
            <div class="container-fluid overflow-hidden text-white">
                <div class="row align-items-start">
                    ...
                    <div id="imageContainer" class="col-6 d-flex justify-content-center align-items-center">
                        <img id="layer2" src="../campus_img/campus_routing.png" alt="Data Center Image" class="img-fluid">
                    </div>
                    <div class="col-6">
                        <div id="iframeContainer" class="ratio">
                            <iframe id="netlab" class="embed-responsive-item"  width="100%" height="100%" data-src="http://192.168.0.10:8988/#/?username=routing_user&password=admin" allowfullscreen></iframe>
                        </div>
                    </div>
            </div>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <script src="../js_routing/main.js"></script>
    <script src="../js_routing/button.js"></script>
