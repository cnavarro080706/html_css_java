...
var topics = ['c_topic2.1.php', 'layer2_switching.png', 'c_lab.php','c_topic2.2.php', 'c_topic2.3.php', 'c_topic2.4.php', 'c_topic2.5.php','c_topic2.6.php','c_topic2.7.php','c_topic2.8.php','c_topic2.9.php','c_topic3.0.php','c_topic3.1.php','c_topic3.2.php']; // Different Topics to be displayed onto the inframe container
var dir = '/html_css_java/TaaS/campus/layer2/';
