...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-5">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><h5 class="mt-1">IP Address Management</h5></a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="">IPAM Services</a></li>
    ...
    <div class="table-responsive-sm ms-5 me-5" style="max-height: 650px; overflow-y: auto;">
        <div class="table-responsive-sm">
            ...
            <div class="container-fluid d-flex justify-content-between align-items-center mb-2">
                <a href="add_ipam.php" class="btn btn-primary">Create New Request</a>
                <div class="d-flex ms-auto">
                    ...
                    <form action="ipam_export.php" method="POST">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="uploadFormModal" method="POST" action="ipam_import.php" enctype="multipart/form-data">
            ...
            <table class="table table-sm table-hover text-center table-striped" id="ipamTable">
                ...
                <tbody class="overflow-auto"> 
                    <?php
                    include "db_conn.php";
                    $sql = "SELECT * FROM ipam ORDER BY IPADDRESS ASC";
                    ...
                    <tr>
                        ...
                        <td class="text-wrap"><?php echo $row['NET_TYPE'] ?></td>
                        <td class="text-wrap"><?php echo $row['SUBNET_TYPE'] ?></td>
                        <td><?php echo $row['CITY'] ?></td>
                        <td class="text-wrap"><?php echo $row['BUILDING'] ?></td>
                        <td><?php echo $row['FLOOR'] ?></td>
                        <td class="text-wrap"><?php echo $row['DATE_CREATED'] ?></td>
                        <td class="text-wrap"><?php echo $row['DATE_MODIFIED'] ?></td>
                        <td>
                            <a href="ipam_edit.php?id=<?php echo $row['ID'] ?>" class="btn btn-primary me-1"><i class="fas fa-edit"></i></a>
                            <a href="ipam_delete.php?id=<?php echo $row['ID'] ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to remove this entry?')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                    }
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function search_table(value) {
                $('#ipamTable tbody tr').each(function() { // only search in tbody rows
                    var found = 'false';
